...
public class AllPCsActivity extends AppCompatActivity
        implements NavigationView.OnNavigationItemSelectedListener {

    private static final String ALL_PCS_LOG_TAG = AllPCsActivity.class.getSimpleName();

    private PCItemViewModel mPCViewModel;
    protected RecyclerView mRecyclerView;
    protected PCAdapter mAdapter;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_all_pcs);
        ...
        this.mRecyclerView = findViewById(R.id.all_pcs_recyclerView);
        this.mAdapter = new PCAdapter(this);
        this.mRecyclerView.setAdapter(this.mAdapter);
        this.mRecyclerView.setLayoutManager(new LinearLayoutManager(this));
        this.mPCViewModel = ViewModelProviders.of(this).get(PCItemViewModel.class);
        this.mPCViewModel.getAllPCItems().observe(this, new Observer<List<PCItem>>()
        {
            @Override
            public void onChanged(@Nullable List<PCItem> pcItems)
            {
                mAdapter.setPCItems(pcItems);
            }
        });
    ...
    public void launchAlertDialog() {
        ...
        AlertDialog.Builder builder = new AlertDialog.Builder(AllPCsActivity.this);
    ...
    public void launchFirstQuestionActivity()
    {
        ...
        Log.d(ALL_PCS_LOG_TAG, "Launched the FirstQuestionActivity with Clicked Button.");
    }
    ...
    public void launchResultActivity()
    {
        ...
        Log.d(ALL_PCS_LOG_TAG, "Launched the ResultActivity with Clicked Button.");
    }
    ...
    public void launchAllPCsActivity()
    {
        ...
        Log.d(ALL_PCS_LOG_TAG, "Launched the AllPCsActivity with Clicked Button.");
    }
    ...
    public void launchAllLaptopsActivity() {
        ...
        Log.d(ALL_PCS_LOG_TAG, "Launched the AllLaptopsActivity with Clicked Button.");
    }
    ...
    public void launchFeedbackActivity() {
        ...
        Log.d(ALL_PCS_LOG_TAG, "Launched the FeedbackActivity with Clicked Button.");
    }
    ...
    public void launchShareActivity() {
        ...
        Log.d(ALL_PCS_LOG_TAG, "Launched the ShareActivity with Clicked Button.");
    }
    ...
    public void launchSettingsActivity() {
        ...
        Log.d(ALL_PCS_LOG_TAG, "Launched the SettingsActivity with Clicked Button.");
    }
    ...
    public void launchAboutActivity() {
        ...
        Log.d(ALL_PCS_LOG_TAG, "Launched the AboutActivity with Clicked Button.");
    }
