...
public class SettingsActivity extends AppCompatActivity
    ...
    private static final String SETTINGS_LOG_TAG = ResultActivity.class.getSimpleName();
    ...
    public void launchFirstQuestionActivity()
    {
        ...
        Log.d(SETTINGS_LOG_TAG, "Launched the FirstQuestionActivity with Clicked Button.");
    }
    ...
    public void launchResultActivity()
    {
        ...
        Log.d(SETTINGS_LOG_TAG, "Launched the ResultActivity with Clicked Button.");
    }
    ...
    public void launchAllPCsActivity()
    {
        ...
        Log.d(SETTINGS_LOG_TAG, "Launched the AllPCsActivity with Clicked Button.");
    }
    ...
    public void launchAllLaptopsActivity() {
        ...
        Log.d(SETTINGS_LOG_TAG, "Launched the AllLaptopsActivity with Clicked Button.");
    }
    ...
    public void launchFeedbackActivity() {
        ...
        Log.d(SETTINGS_LOG_TAG, "Launched the FeedbackActivity with Clicked Button.");
    }
    ...
    public void launchShareActivity() {
        ...
        Log.d(SETTINGS_LOG_TAG, "Launched the ShareActivity with Clicked Button.");
    }
    ...
    public void launchSettingsActivity() {
        ...
        Log.d(SETTINGS_LOG_TAG, "Launched the SettingsActivity with Clicked Button.");
    }
    ...
    public void launchAboutActivity() {
        ...
        Log.d(SETTINGS_LOG_TAG, "Launched the AboutActivity with Clicked Button.");
    }
