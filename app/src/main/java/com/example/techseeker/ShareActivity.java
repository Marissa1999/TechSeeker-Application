...
public class ShareActivity extends AppCompatActivity
    ...
    private static final String SHARE_LOG_TAG = ResultActivity.class.getSimpleName();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mShareTextEditText = findViewById(R.id.share_info);
    }

    public void launchShareButton(View view) {
    ...
    public void launchFirstQuestionActivity()
    {
        ...
        Log.d(SHARE_LOG_TAG, "Launched the FirstQuestionActivity with Clicked Button.");
    }
    ...
    public void launchResultActivity()
    {
        ...
        Log.d(SHARE_LOG_TAG, "Launched the ResultActivity with Clicked Button.");
    }
    ...
    public void launchAllPCsActivity()
    {
        ...
        Log.d(SHARE_LOG_TAG, "Launched the AllPCsActivity with Clicked Button.");
    }
    ...
    public void launchAllLaptopsActivity() {
        ...
        Log.d(SHARE_LOG_TAG, "Launched the AllLaptopsActivity with Clicked Button.");
    }
    ...
    public void launchFeedbackActivity() {
        ...
        Log.d(SHARE_LOG_TAG, "Launched the FeedbackActivity with Clicked Button.");
    }
    ...
    public void launchShareActivity() {
        ...
        Log.d(SHARE_LOG_TAG, "Launched the ShareActivity with Clicked Button.");
    }
    ...
    public void launchSettingsActivity() {
        ...
        Log.d(SHARE_LOG_TAG, "Launched the SettingsActivity with Clicked Button.");
    }
    ...
    public void launchAboutActivity() {
        ...
        Log.d(SHARE_LOG_TAG, "Launched the AboutActivity with Clicked Button.");
    }
