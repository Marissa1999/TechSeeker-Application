...
public class AboutActivity extends AppCompatActivity
    ...
    private static final String ABOUT_LOG_TAG = ResultActivity.class.getSimpleName();
    ...
    public void launchContactUsButton(View view) {
        Intent intent = getIntent();
        finish();
        startActivity(intent);

        String launchingMainMessage = "Your message has been sent! Thank you!";
    ...
    public void launchFirstQuestionActivity()
    {
        ...
        Log.d(ABOUT_LOG_TAG, "Launched the FirstQuestionActivity with Clicked Button.");
    }
    ...
    public void launchResultActivity()
    {
        ...
        Log.d(ABOUT_LOG_TAG, "Launched the ResultActivity with Clicked Button.");
    }
    ...
    public void launchAllPCsActivity()
    {
        ...
        Log.d(ABOUT_LOG_TAG, "Launched the AllPCsActivity with Clicked Button.");
    }
    ...
    public void launchAllLaptopsActivity() {
        ...
        Log.d(ABOUT_LOG_TAG, "Launched the AllLaptopsActivity with Clicked Button.");
    }
    ...
    public void launchFeedbackActivity() {
        ...
        Log.d(ABOUT_LOG_TAG, "Launched the FeedbackActivity with Clicked Button.");
    }
    ...
    public void launchShareActivity() {
        ...
        Log.d(ABOUT_LOG_TAG, "Launched the ShareActivity with Clicked Button.");
    }
    ...
    public void launchSettingsActivity() {
        ...
        Log.d(ABOUT_LOG_TAG, "Launched the SettingsActivity with Clicked Button.");
    }
    ...
    public void launchAboutActivity() {
        ...
        Log.d(ABOUT_LOG_TAG, "Launched the AboutActivity with Clicked Button.");
    }
